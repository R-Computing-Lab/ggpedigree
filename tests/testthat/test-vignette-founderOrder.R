test_that("vignette section 12 code runs without error", {
  ...
  # Default layout
  p_default <- suppressWarnings(ggPedigree(potter, famID = "famID", personID = "personID",
    momID = "momID", dadID = "dadID",
    config = list(label_include = TRUE, label_text_size = 2.5)))
  expect_s3_class(p_default, "gg")

  # Seed 7
  p_seed7 <- suppressWarnings(ggPedigree(potter, famID = "famID", personID = "personID",
    momID = "momID", dadID = "dadID",
    config = list(founder_order_seed = 7L, label_include = TRUE, label_text_size = 2.5)))
  expect_s3_class(p_seed7, "gg")

  # Seed 42
  p_seed42 <- suppressWarnings(ggPedigree(potter, famID = "famID", personID = "personID",
    momID = "momID", dadID = "dadID",
  ...
  # Auto-search
  p_best <- suppressWarnings(ggPedigree(potter, famID = "famID", personID = "personID",
    momID = "momID", dadID = "dadID",
    config = list(founder_order_seed = 1L, founder_order_tries = 5L,
