...
The ggpedigree R package complements the BGmisc package by providing a set of functions for visualizing pedigree data using ggplot2. It is designed to work seamlessly with the BGmisc package, which provides tools for simulating, manipulating, and modeling pedigree data. It extends the plotting functionality of the `kinship2` package, which is widely used for pedigree analysis in R.
