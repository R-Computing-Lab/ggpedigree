...
This resubmitted version includes minor quality of life improvements to the code base and a few new features, but no major changes to the underlying functionality. In the first attempted submission I  missed a URL that had redirected to a new location, but I have updated the URL and verified that it is correct. 
...
2. **GitHub Actions**:  
    - [Link](https://github.com/R-Computing-Lab/ggpedigree/actions/runs/23066017907)
...
── R CMD check results ─────────── ggpedigree 1.1.1.0.0 ────
Duration: 2m 18.2s
