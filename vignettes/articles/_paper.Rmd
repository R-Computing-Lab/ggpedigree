...
I demonstrate several advanced features by restyling a figure from [@hunter2025tracing], to follow the Wake Forest brand identity guidelines. The source code for transforming these potter data is available in the package documentation on . The resulting figure appears below:
