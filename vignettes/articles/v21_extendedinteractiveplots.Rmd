---
title: "Extended: More Interactive Pedigree Plots with ggPedigreeInteractive"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Extended: More Interactive Pedigree Plots with ggPedigreeInteractive}
...
This vignette demonstrates how to create interactive pedigree plots using the `ggPedigreeInteractive()` function from the `ggpedigree` package. It extends the basic examples found in the main package documentation.
