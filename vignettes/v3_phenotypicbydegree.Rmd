...
The example below uses a squirell pedigree dataset to illustrate how to create a plot showing the phenotypic correlation across different degrees of relatedness.
